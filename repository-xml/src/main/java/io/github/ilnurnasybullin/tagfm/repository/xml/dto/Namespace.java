...
public class Namespace implements NamespaceRepoDto {
    ...
    private Namespace(String name, ZonedDateTime created, FileNamingStrategy fileNaming,
    ...
    public static Namespace singleRoot(NamespaceEntity namespace) {
