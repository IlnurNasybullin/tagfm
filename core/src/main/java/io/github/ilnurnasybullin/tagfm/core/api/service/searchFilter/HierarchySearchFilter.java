...
public class HierarchySearchFilter implements TaggedFilesFilter {
    ...
    private HierarchySearchFilter(BooleanExpressionEvaluator<TagView> evaluator) {
    ...
    public static TaggedFilesFilter of(NamespaceView namespace,
        ...
        BooleanExpressionEvaluator<TagView> mappedEvaluator = evaluator.map(usedTags::get);
